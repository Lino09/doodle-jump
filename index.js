 document.addEventListener('DOMContentLoaded', () => {
    let newDiv
//Some Shit I did to call the game anytme I want
...
//THE ACTUAL GAME
     ...
     function startGame() {
        ...
        const doodler = document.createElement('div')    
         ...
         grid.style.background = "url('./media/bg-matrix.gif') black"
         // CLASS
         ...
         grid.style.background = "url('./media/froze-bg.png') black"
